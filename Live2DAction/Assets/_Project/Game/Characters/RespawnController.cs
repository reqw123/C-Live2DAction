...
namespace Live2DAction.Characters
{
    ...
    // "the character vanished" (2026-08-12 real bug report: Enemy's attacks landing reliably
    ...
    // 2026-08-13 explicit user request extended it to Mecha too (still passive - it just now
    ...
    // "Missing Script"). A second instance lives on "GameManager" wired to Mecha.
    //
