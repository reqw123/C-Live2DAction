...
{
    // Adds a new standalone standee GameObject ("Enemy") using a free anime-style Sketchfab
    ...
    // it, matching Mecha's precedent) and a LockOnTarget (explicitly requested as a "might
    ...
    internal static class EnemyAnimeVisualSetup
    {
        ...
        private const string StandeeName = "Enemy";

        // Clear of FemaleStandee (0,0,-8) / NatsuStandee (-6,0,-8) / LucyStandee (-3,0,-8) /
        // Mecha (2.5,0,-2) - same back row as the Live2D standees, further along +X.
        private static readonly Vector3 StandeePosition = new Vector3(5f, 0f, -8f);

        [MenuItem("Tools/Live2DAction/Add Anime Character As Enemy Standee")]
        ...
        // renderer bounds the way MechaVisualSetup does).
