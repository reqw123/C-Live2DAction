...
namespace Live2DAction.EditorTools
{
    ...
    // attack. See EnemyAI's own "combat" field comment for the permanent fix: wires Enemy's
    ...
    internal static class EnemyEffectiveAttackRangeSetup
    {
        private const string ScenePath = "Assets/_Project/Scenes/GreyboxTest.unity";

        [MenuItem("Tools/Live2DAction/Wire Enemy Effective Attack Range")]
        public static void Apply()
        {
            ...
            {
                Debug.LogError("Enemy needs both EnemyAI and PlayerCombat in " + ScenePath);
                return;
            }
            ...
            Debug.Log("Enemy's EnemyAI now derives its attack range live from PlayerCombat's actual AttackData (Range+Radius) - no more manual attackRange syncing needed.");
        }
    }
}
